...
\usepackage[framed=true]{styles/mdftheorems}
%\usepackage{styles/plaintheorems}

% Load the package for hyperreferences
\usepackage{styles/kaorefs}

\graphicspath{{./figs/}{figs/}} % Paths in which to look for images
...
\title{Spatial Airports: GIS for Airside Civil and Land Operations}
\author{Mumtaz Endy}
\date{\texttt{v0.0.1}}

\publishers{\vspace{15mm}\includegraphics[width=0.8\linewidth]{figs/naco.jpg}}
%----------------------------------------------------------------------------------------
...
\include{gisoverview/gisoverview}      %- 01
\include{airsideintro/airsideintro}    %- 02
%\include{geodatatools/geodatatools}   %- 03
%\include{applications/applications}   %- 04
%\include{advanced/advanced}           %- 05
%\include{future/future}               %- 06
%\include{getstart/getstart}           %- 07
